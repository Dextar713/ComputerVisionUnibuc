...
from MovieFaceDetection.code.Parameters import is_test
...
solution_path_root = "../../saved_files/solution/"
if not is_test:
    ground_truth_path_root = "../../validare/"
else:
    ground_truth_path_root = "../../testare/"
...
if not is_test:
    target_word = 'validare'
else:
    target_word = 'testare'
ground_truth_path = ground_truth_path_root + f"task2_daphne_gt_{target_word}.txt"
evaluate_results_task2(solution_path, ground_truth_path, "daphne", verbose)

ground_truth_path = ground_truth_path_root + f"task2_fred_gt_{target_word}.txt"
evaluate_results_task2(solution_path, ground_truth_path, "fred", verbose)

ground_truth_path = ground_truth_path_root + f"task2_shaggy_gt_{target_word}.txt"
evaluate_results_task2(solution_path, ground_truth_path, "shaggy", verbose)

ground_truth_path = ground_truth_path_root + f"task2_velma_gt_{target_word}.txt"
